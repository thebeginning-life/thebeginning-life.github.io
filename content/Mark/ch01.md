...
(vs 4)John came--ceremonially immersing people in water(tn "baptizing, which means "immersing"") in the desert and proclaiming the path(tn "baptism") (xr "Mrk 10:38-40") to immerse one's life in.  This path(tn "baptism") required people to choose God’s road instead of their own(tn "repent"), in order to be forgiven for preferring selfish pleasure(xr "Jas 4:1-3") (and the hurt that this causes) instead(tn "sins").
